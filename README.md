## 👋 Привет, я Михаил
  ...
  - Разработал микросервис синхронизации товаров с маркетплейсами
  - Внедрил асинхронную обработку задач (RabbitMQ) — тяжёлые операции ушли
  в фон, API остался отзывчивым
  - Оптимизировал SQL-запросы — повышение производительности примерно на 25%
  ...
  - Вакансия: Backend-разработчик / DevOps
